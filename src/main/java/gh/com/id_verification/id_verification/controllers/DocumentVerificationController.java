...
public class DocumentVerificationController {
    ...
    public @ResponseBody ResponseEntity<String> queryIdVerificationWithFile( @RequestPart(value = "file") MultipartFile file,
    ...
    public @ResponseBody ResponseEntity<String> queryIdVerification(@RequestBody @Valid IdVerificationServiceRequestDto requestDto){
